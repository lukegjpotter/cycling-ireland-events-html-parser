...
@SpringApplicationConfiguration(classes = { CyclingIrelandEventsHtmlScraperApplication.class, PhoneNumberUtilsService.class })
public class PhoneNumberUtilsServiceTest {
    
    @Autowired PhoneNumberUtilsService phoneNumberUtilsService;
