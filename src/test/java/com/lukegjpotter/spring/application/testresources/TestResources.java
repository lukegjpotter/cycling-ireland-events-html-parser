...
public class TestResources {
    ...
    public String getPhoneNumberDoubleIrelandPrefixDescriptionFileName() {
        return "./src/test/resources/PhoneNumberDoubleIrelandPrefixDescription.html";
    }

    public Description getPhoneNumberDoubleIrelandPrefixDescription() {
        Description description = new Description();
